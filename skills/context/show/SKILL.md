...
4. Optionally run **`node {{base:scripts/context}}/show.js`** from the **workspace root** (or with **`CURSOR_ROOT`** pointing at it) to print the same summary to the terminal.
